        ...
        <div class="card p-2 py-3 shadow">
            <div class="card-content">
                ...
                >
                    <div class="row">
                        <div class="col-3">
                            <img src="<?php echo URLROOT . '/images/storage/' . $data["image_path"] ; ?>" alt="Neues Bild erscheint hier" id="image-preview" class="img-thumbnail">
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <input 
                                    type="file" 
                                    class="form-control-file <?php echo (!empty($data["image_error"]) ? 'is-invalid' : ''); ?>" 
                                    name="image" 
                                    id="image" 
                                    aria-describedby="fileHelpId"
                                    src="<?php echo URLROOT . '/images/storage/' . $data["image_path"] ; ?>"
                                >
                        ...
                        <div class="col-12 d-inline">
                            <div class="d-flex justify-content-between">
                                ...
                                <input class="btn btn-outline-success" type="submit" value="Bearbeiten">
                            </div>
                        </div>
                    </div>
